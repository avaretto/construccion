<html>
    ...
    <body>
        <?php
            ...
            //generar consultas
            //0. cantidad a devolver
        
            $consulta0 = "SELECT cant_material FROM det_entrega
                            WHERE id_det = '$detalle'";
            
            $resultado0 = mysqli_query($conexion, $consulta0);
        
        
            if($fila = mysqli_fetch_array($resultado0)){
                echo  $cantidad = $fila['cant_material'];
                //devolver stock
                $consulta1 = "UPDATE material
                            SET stock_mat = stock_mat + '$cantidad'
                            WHERE id_mat =(SELECT fk_material
                            FROM det_entrega
                            WHERE id_det ='$detalle')";
                
                //borrar detalle entrega
                
                $consulta2 = "DELETE FROM det_entrega
                            WHERE id_det ='$detalle'";
            ...
            /*
            //1. actualizar stock (se necesita cant a devolver)

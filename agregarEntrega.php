<html>
    ...
    <body>
        <?php
            ...
            //generar consultas
            $consulta = "INSERT INTO entrega (fec_ent, fk_bodeguero, fk_obrero)
            VALUES(?,?,?)";
            ...
            if($ok == false){
                ...
                //guardar id entrega
                $consulta2 = "SELECT max(id_ent) as 'idMax' FROM entrega";
                $resultado2 = mysqli_query($conexion, $consulta2);
                
                //guardar ID entrega (el ultimo, es decir el maximo) en variable global
                $dato = mysqli_fetch_array($resultado2);
                $_SESSION['idEntrega']=$dato['idMax'];
    
                header('location: moduloEntrega.php');
            }

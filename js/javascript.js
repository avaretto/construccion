...
function clicCerrar(){
    //alert("clic menu");
    document.getElementById("actualizarStockMat").style.display="none";
}

/*-----------------------------funciones multiples----------------------*/
//clicVerEntrega: se usa en módulo de bodeguero y en módulo de obrero
...
function clicVerEntrega(){
    //alert("clic menu");
    window.location.assign("listadoEntrega.php");
}
...
/*-----------------------------módulo Entrega-------------------------*/
function clicBuscarMaterial(){
    //alert("clic menu");
    window.location.assign("listadoDetEntrega.php");
}
function clicVolverListadoDetEntrega(){
    //alert("clic menu");
    window.location.assign("listadoDetEntrega.php");  
}
